...
public interface BoardMapper {
	...
	@Insert("insert into content_table(content_idx, content_subject, content_text, " +
			...
			"#{content_writer_idx}, #{content_board_idx}, CURDATE(), #{content_location} ) ")
	...
	// 게시판 리스트 가져오기
	@Select("select a1.content_idx, a1.content_location as content_location, a1.content_subject, a2.user_name as content_writer_name, " + 
	...
	@Select("select a2.user_name as content_writer_name,  " + 
			"      a1.content_date as content_date, " + 
			"       a1.content_subject, a1.content_text, a1.content_file, a1.content_writer_idx, a2.user_id as content_writer_id, a1.content_location as content_location  " + 
			"from content_table a1, user_table a2 " + 
			"where a1.content_writer_idx = a2.user_idx " + 
	...
	@Update("update content_table " + "set content_subject  = #{content_subject}, content_text = #{content_text}, "
			+ "content_location = #{content_location}, content_file = #{content_file, jdbcType=VARCHAR} " + "where content_idx = #{content_idx}")
